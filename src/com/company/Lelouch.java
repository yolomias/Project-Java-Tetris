...
public class Lelouch extends Tetruino {
    ...
    protected void platziereBlocks() {
        ...
        tetruBlocks.get(3).setLocation(125, 100);
    }
    ...
    public void rotate(char rotation) {
        ...
        switch (getRotation()) {
            case 1:
                tetruBlocks.get(0).setLocation(tetruBlocks.get(0).getPosX() + 25, tetruBlocks.get(0).getPosY());
                tetruBlocks.get(1).setLocation(tetruBlocks.get(1).getPosX(), tetruBlocks.get(1).getPosY() + 25);
                tetruBlocks.get(2).setLocation(tetruBlocks.get(2).getPosX() - 25, tetruBlocks.get(2).getPosY() + 50);
                tetruBlocks.get(3).setLocation(tetruBlocks.get(3).getPosX() - 50, tetruBlocks.get(3).getPosY() + 25);
                break;
            ...
            case 2:
                ...
                tetruBlocks.get(3).setLocation(tetruBlocks.get(3).getPosX(), tetruBlocks.get(3).getPosY() - 50);
                break;

            case 3:
                tetruBlocks.get(0).setLocation(tetruBlocks.get(0).getPosX() - 50, tetruBlocks.get(0).getPosY() + 25);
                tetruBlocks.get(1).setLocation(tetruBlocks.get(1).getPosX() - 25, tetruBlocks.get(1).getPosY());
                tetruBlocks.get(2).setLocation(tetruBlocks.get(2).getPosX(), tetruBlocks.get(2).getPosY() - 25);
                tetruBlocks.get(3).setLocation(tetruBlocks.get(3).getPosX() + 25, tetruBlocks.get(3).getPosY());
                break;

            case 4:
                tetruBlocks.get(0).setLocation(tetruBlocks.get(0).getPosX(), tetruBlocks.get(0).getPosY() - 50);
                tetruBlocks.get(1).setLocation(tetruBlocks.get(1).getPosX() + 25, tetruBlocks.get(1).getPosY() - 25);
                tetruBlocks.get(2).setLocation(tetruBlocks.get(2).getPosX() + 50, tetruBlocks.get(2).getPosY());
